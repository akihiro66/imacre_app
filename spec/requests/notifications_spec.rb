  ...
  context "通知処理" do
    ...
    context "自分の作品に対して" do
      ...
      it "コメントによって通知が作成されないこと" do
        post comments_path, params: { production_id: production.id,
                                      comment: { content: "最高です！" } }
        expect(user.reload.notification).to be_falsey
      end
    end
